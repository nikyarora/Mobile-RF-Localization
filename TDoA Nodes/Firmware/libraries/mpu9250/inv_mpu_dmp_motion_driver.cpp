...
int dmp_enable_feature_std()
{
    ...
    /* Send sensor data to the FIFO. No Accel, yes gyro*/
    tmp[0] = 0xA3;
    tmp[1] = 0xA3;
    tmp[2] = 0xA3;
    tmp[3] = 0xA3;
    ...
    /* Send gesture data to the FIFO. No tap, no android*/
    tmp[0] = 0xD8;
    mpu_write_mem(CFG_27,1,tmp);
    ...
    /* Pedometer is always enabled. */
    dmp->feature_mask = DMP_FEATURE_6X_LP_QUAT|DMP_FEATURE_SEND_CAL_GYRO|DMP_FEATURE_GYRO_CAL | DMP_FEATURE_PEDOMETER;
    mpu_reset_fifo();

    dmp->packet_length = 22;
...
int dmp_read_fifo_simpl(short *gyro, long *quat, unsigned char *more)
{
    ...
    gyro[0] = ((short)fifo_data[16+0] << 8) | fifo_data[16+1];
    gyro[1] = ((short)fifo_data[16+2] << 8) | fifo_data[16+3];
    gyro[2] = ((short)fifo_data[16+4] << 8) | fifo_data[16+5];
    return 0;
}
