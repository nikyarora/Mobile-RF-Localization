...
namespace Crc
{
    ...
    uint16_t icrc1(uint16_t, uint8_t onech);
    uint16_t icrc(uint16_t crc, const uint8_t *bufptr, unsigned long len, short jinit, int jrev);
    uint16_t Crc16_ccitt(const uint8_t *data, unsigned size);
