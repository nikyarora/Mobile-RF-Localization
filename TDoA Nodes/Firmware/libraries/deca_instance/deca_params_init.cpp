...
#else
PROGMEM const uint32 tx_config[NUM_CH] =
#endif
{
...
{
#else
PROGMEM const uint32 digital_bb_config_0[NUM_PACS] = 
#endif
        //16 PRF
        {
            //PAC 8
...
PROGMEM const uint32 digital_bb_config_1[NUM_PACS] = 
#endif
        //64 PRF
        {
            //PAC 8
...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
PROGMEM const uint16 lde_replicaCoeff[PCODES] = {
#else
