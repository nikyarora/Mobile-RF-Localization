...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
...
#ifndef DWT_STORE_TABLES_IN_PROGMEM
const uint8 range25cm16PRFnb[4][NUM_16M_OFFSET] =
{
#else 
    PROGMEM const uint8 range25cm16PRFnb_0[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm16PRFnb_1[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm16PRFnb_2[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm16PRFnb_3[NUM_16M_OFFSET] =
#endif
...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
const uint8 *range25cm16PRFnb[4] =
{
    range25cm16PRFnb_0, range25cm16PRFnb_1, range25cm16PRFnb_2, range25cm16PRFnb_3
};
#endif
...
{
#else 
    PROGMEM const uint8 range25cm16PRFwb_0[NUM_16M_OFFSETWB] =
#endif
    ...
    PROGMEM const uint8 range25cm16PRFwb_1[NUM_16M_OFFSETWB] =
#endif
...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
const uint8 *range25cm16PRFwb[2] =
{
    range25cm16PRFwb_0, range25cm16PRFwb_1
};
#endif
...
{
#else 
    PROGMEM const uint8 range25cm64PRFnb_0[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm64PRFnb_1[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm64PRFnb_2[NUM_16M_OFFSET] =
#endif
    ...
    PROGMEM const uint8 range25cm64PRFnb_3[NUM_16M_OFFSET] =
#endif
...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
const uint8 *range25cm64PRFnb[4] =
{
    range25cm64PRFnb_0, range25cm64PRFnb_1, range25cm64PRFnb_2, range25cm64PRFnb_3
};
#endif
...
{
#else 
    PROGMEM const uint8 range25cm64PRFwb_0[NUM_16M_OFFSETWB] =
#endif
    ...
    PROGMEM const uint8 range25cm64PRFwb_1[NUM_16M_OFFSETWB] =
#endif
...
#ifdef DWT_STORE_TABLES_IN_PROGMEM
const uint8 *range25cm64PRFwb[2] =
{
    range25cm64PRFwb_0, range25cm64PRFwb_1
};
#endif

const uint8 dwt_getrangetablebias(uint8 i, uint8 j)
{
#ifndef DWT_STORE_TABLES_IN_PROGMEM
    return range25cm64PRFwb[i][j];
#else
    return (uint8)pgm_read_byte_near(range25cm64PRFwb[i]+j);
#endif
}
...
double dwt_getrangebias(uint8 chan, float range, uint8 prf)
{
    ...
    int i = 0 ;
    int chanIdx ;
    int cmoffseti=0 ;                               // integer number of CM offset
...
#else
                while (rangeint25cm > (uint8)pgm_read_byte_near(range25cm16PRFwb[chanIdx]+i)) i++;
#endif
...
#else
                while (rangeint25cm > (uint8)pgm_read_byte_near(range25cm16PRFnb[chanIdx]+i)) i++;
#endif
...
#else
                while (rangeint25cm > (uint8)pgm_read_byte_near(range25cm64PRFwb[chanIdx]+i)) i++;
#endif
...
#else
                while (rangeint25cm > (uint8)pgm_read_byte_near(range25cm64PRFnb[chanIdx]+i)) i++;
#endif
